...
export const ProductDetailsPage = () => {
  const { products, setProducts, localStore, setLocalStore } =
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const productsFromApi: ProductDetailsType = await getProducts(
  ...
  const handleBtnClick = (action: string) => {
    ...
    const index = currentProducts.findIndex(
      product => product.id === updatedCard.id,
    );

    const indexStore = currentStoreState.findIndex(
      storeItem => storeItem.id === updatedCard.id,
    );
        ...
        currentProduct && (
          <>
            <div className="product-details_body">
              <h2 className="product-details_title page-title-style">
                {currentProduct.name}
              </h2>
              ...
              <div className="right-box">
                ...
                <table className="short-specs">
                  <tbody>
                    <tr>
                      <td className="short-specs_name small-text-style">
                        Screen
                      </td>
                      <td className="short-specs_details small-text-style">
                ...
                <div className="about">
                  ...
                  {currentProduct.description.map((item, index) => (
                    ...
                    <div className="about_section" key={index}>
                      <h3 className="about_section-title h3-text-style">
                        {item.title}
                      </h3>
                      <p className="about_section-text body-text-style">
                        {item.text}
                      </p>
                    </div>
                  ))}
